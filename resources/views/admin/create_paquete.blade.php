    ...
    <div class="page-header pl-5">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <span class="breadcrumb-item active">Creando nuevo paquete</span>
            </nav>
        </div>
    </div>


    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.store_paquete') }}">
        @csrf
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3"
                            placeholder="Título del paquete" name="titulo" required>
                    </div>
                    <div class="col-12 col-md-3 input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3"
                            placeholder="Duración del paquete" name="duracion" required>
                    </div>
                    <div class="col-12 col-md-3 input-group mb-3">
                        <div class="input-group-prepend">
                        ...
                        <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3"
                            placeholder="Precio del paquete" name="can_personas" required>
                    </div>
                    <div class="col-12 col-md-3 input-group mb-3">
                        <div class="input-group-prepend">
                        ...
                        <select class="select2 form-control" name="tipo">
                            ...
                            <option value="treks">Caminata</option>
                    ...
                    <div class="col-12 col-md-4 input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3"
                            placeholder="Altitud" name="altitud" required>
                    </div>
                    <div class="col-12 col-md-4 input-group mb-3">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3"
                            placeholder="Ubicación" name="ubicacion" required>
                    </div>
                    <div class="col-12 col-md-4 input-group mb-3">
                        <div class="input-group-prepend">
            ...
            if (document.getElementById('editor') && !window.quillDescripcion) {
                ...
                document.querySelector('form').onsubmit = function(event) {
                    ...
                    if (!descripcion.value.trim()) {
                        ...
                        event.preventDefault(); // Prevenir el envío si no hay contenido
                    }
                };
