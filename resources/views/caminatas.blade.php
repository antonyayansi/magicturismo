            ...
            <div class="row">
                <div class="col-xxl-12 col-lg-12">
                    <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="col-md-3">
                                        <div class="tour-box th-ani">
                                            ...
                                            <div class="tour-content">
                                                <h3 class="box-title">
                                                    <a href="{{ route('caminatadetalle', ['slug' => $caminata->slug]) }}">{{ $caminata->titulo }}</a>
                                                </h3>
                                                
                                                <h4 class="tour-box_price">
                                                    <span class="currency">${{ $caminata->precio }}</span>/Persona
                                                </h4>
                                                <div class="tour-action">
                                                    <span>
                                                        <i class="fa-light fa-clock"></i>{{ $caminata->duracion }}
                                                    </span>
                                                    <a href="{{ route('caminatadetalle', ['slug' => $caminata->slug]) }}" class="th-btn style4">Ver Detalle</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {{ $caminatas->links('vendor.pagination.custom') }}
