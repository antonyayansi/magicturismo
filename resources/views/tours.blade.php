@extends('layout.es')
@section('titulo', 'Tours - Magic Tours')
@section('palabras')
@section('descripcion')
@section('contenido')
    ...
    <div class="breadcumb-wrapper" data-bg-src="{{ asset('assets/img/bg/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Nuestros Tours</h1>
                <ul class="breadcumb-menu">
                    <li><a href="{{ route('home') }}">Home</a></li>
                    <li>Nuestros Tours</li>
                </ul>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="tour-box th-ani">
                                            <div class="tour-box_img global-img">
                                                <img src="{{ Storage::url(  $tour->imagen) }}" alt="image">
                                            </div>
                                            <div class="tour-content">
                                                <h3 class="box-title">
                                                    <a href="{{ route('toursdetalle', ['slug' => $tour->slug]) }}">{{ $tour->titulo }}</a>
                                                </h3>
                                                ...
                                                <div class="tour-action">
                                                    ...
                                                    <a href="{{ route('toursdetalle', ['slug' => $tour->slug]) }}" class="th-btn style4">Ver Detalle</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
